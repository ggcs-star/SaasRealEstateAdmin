...
export default function Index({ auth, propertyTypes, categories }) {
    ...
    // Stats calculations
    const totalTypes = propertyTypes?.length || 0;
    const activeTypes = propertyTypes?.filter(p => p.status).length || 0;
    const inactiveTypes = propertyTypes?.filter(p => !p.status).length || 0;
    const uniqueCategories = new Set(propertyTypes?.map(p => p.category?._id).filter(Boolean)).size || 0;
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                    ...
                    <div className="px-8 py-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Property Types</h1>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button
                                    onClick={openCreate}
                                    className="group relative inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-medium rounded-xl shadow-lg shadow-emerald-200 hover:shadow-xl hover:shadow-emerald-300 hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
                                >
                ...
                {/* Stats Cards */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-8 pt-6">
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-500">Total Types</p>
                                <p className="text-2xl font-bold text-gray-800">{totalTypes}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-emerald-600">{activeTypes}</p>
                            </div>
                            <div className="p-3 bg-emerald-100 rounded-xl">
                                <svg className="w-6 h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="mt-2 w-full bg-gray-200 rounded-full h-1.5">
                            <div className="bg-emerald-500 h-1.5 rounded-full" style={{ width: `${totalTypes > 0 ? (activeTypes / totalTypes) * 100 : 0}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-800">{inactiveTypes}</p>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        className="pl-10 pr-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 w-64"
                                    />
                                </div>
                                        ...
                                        propertyTypes.map((item) => (
                                            ...
                                            >
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center space-x-3">
                                                        <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-emerald-100 to-teal-50 rounded-xl flex items-center justify-center border-2 border-emerald-200 group-hover:border-emerald-300 transition-colors">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center space-x-3">
                                                        <button
                                                            ...
                                                            className="p-2 text-emerald-600 hover:bg-emerald-100 rounded-lg transition-all duration-200 hover:scale-110 group/edit"
                                                            title="Edit"
                                                        >
                                        ...
                                        <tr>
                                            <td colSpan="4" className="px-6 py-12 text-center">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <p className="text-sm text-gray-500">Get started by creating your first property type</p>
                                                    <button
                                                        onClick={openCreate}
                            ...
                            <div className="px-6 py-4 border-t border-gray-200 bg-gray-50/50">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <button className="px-3 py-1 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors">
                                            1
                                        </button>
                                        <button className="px-3 py-1 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors" disabled>
                                            Next
                                        </button>
                                    </div>
                                </div>
