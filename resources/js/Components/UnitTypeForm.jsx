...
export default function UnitTypeForm({ unitType, closeModal }) {
    const { data, setData, post, put, processing } = useForm({
        name: unitType?.name || "",
        bhk: unitType?.bhk || "",
        description: unitType?.description || "",
        meta_title: unitType?.meta_title || "",
        meta_description: unitType?.meta_description || "",
        meta_keywords: unitType?.meta_keywords || "",
        status: unitType?.status ?? true
    });
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
            ...
            <div className="bg-white w-[650px] rounded-2xl shadow-2xl animate-slideUp overflow-hidden">
                ...
                <div className="relative bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-800 px-6 py-5">
                    ...
                    <div className="flex items-center justify-between relative">
                        <div className="flex items-center space-x-4">
                            <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm border border-white/30 shadow-lg transform hover:scale-110 transition-transform">
                                {unitType ? (
                ...
                {/* Form Content */}
                <form onSubmit={submit} className="p-6 max-h-[70vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                    <div className="space-y-5">
                        ...
                        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border-2 border-gray-200">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <label className="font-medium text-gray-700">Unit Status</label>
                                    <p className="text-xs text-gray-500">Toggle to activate or deactivate this unit type</p>
                                </div>
                            </div>
                            <button
                                type="button"
                            ...
                            >
                                <span
                                    className={`inline-block h-6 w-6 transform rounded-full bg-white shadow-lg transition-transform duration-300 ${
                                        data.status ? 'translate-x-9' : 'translate-x-1'
                                    }`}
                                />
                            </button>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4 border border-indigo-200/50">
                            ...
                            <div className="text-sm text-gray-600">
                                ...
                                <span className="ml-1">{data.bhk || "X"} BHK Configuration</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <span className="relative z-10 flex items-center">
                                {processing ? (
                                    ...
                                    <>
                                        ...
                                        {unitType ? "Update Unit Type" : "Create Unit Type"}
                                    </>
                                )}
                            </span>
                        </button>
